...
<div class="p-b-60">
				...
				<div id="ajax_content">
                    <div class="row">
							...
							?>
									...
									?></p>
                                        ...
                                        <div class="col-xl-3 col-lg-3">
                                            <p>Unit Price <span class="d-inline-block ml-4 fontwieghtbold fontsize24 greencolortext"><?php 
							    ...
							    ?>
                                        <div class="col-xl-8 col-lg-8 col-md-6">
                                            <div class="d-flex">
                                                <input type="text" name="discount[<?php echo $discount_codes['code']; ?>]" placeholder="Coupen Code" class="form-control mr-3 h-45 w-170" value="<?php echo $discount_codes['code']; ?>">
                                                <button  type="submit" class="borderradius50 fontsize14 btn btn-blue-fill" name="update_discount" value="Add Discount Code">Apply Coupen</button>
                                            </div>
                                        </div>
                                        <?php }} }?>
                                        <?php if($this->session->userdata('uid') == ''){ ?>
                                        <div class="col-xl-8 col-lg-8 col-md-6">
                                            <div class="d-flex">
                                                <input type="text" name="discount[0]" placeholder="Coupen Code" class="form-control mr-3 h-45 w-170" value="">
                                                <button  type="submit" class="borderradius50 fontsize14 btn btn-blue-fill" name="update_discount" value="Add Discount Code">Apply Coupen</button>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-6 text-md-right"><button  type="submit" name="update" value="Update Cart" class="borderradius50 fontsize14 btn btn-blue">Update Cart</button></div>
                                         <?php }else{ ?>
						...
						<table id="cart_shipping" class="table table-striped">
							<thead>
								<tr>
							...
							<tbody>
								<tr>
									<td style="padding: 30px;">
										<label class="spacer_250"><strong>Country:</strong>
								    ...
								    <td>
                                        <label class="spacer_200"><strong>State:</strong>
    ...
    `                               
                                        <input type="hidden" name="shipping[postal_code]" value="<?php echo $this->flexi_cart->shipping_location_name(3);?>"/>
                                    </td>
                                    <td>
                                        <label class="spacer_125"><strong>Shipping Options:</strong>
...
<!--                                            <option value="0"> - Shipping Options - </option>-->
							...
							<tfoot>
								<tr>
									<td colspan="3">
										<small>Note: This section also updates tax rates based on the shipping location.</small>
									</td>
								</tr>
							</tfoot>
						</table>
					...
					<?php } else { ?>					
						...
						<table id="cart_shipping" class="table table-striped">
							...
							<tbody>
								...
								<tr>
									<td>
										<label style="width:100%">Shipping Options:
											<select name="shipping[manual_option]" style="width:80%">
												<option value="0"> - Shipping Options - </option>
											<?php 
												if (! empty($shipping_options)) {
													foreach($shipping_options as $shipping) { 
					...
					<div class="table-responsive">
						<table id="cart_summary" class="">
							...
							<tbody>
								...
								<tr>
									<td>
										Shipping: <strong>[<?php echo $this->flexi_cart->shipping_name();?>]</strong>
									</td>
									<td>
                        ...
                        <div class="btn-group m-t-20 w-50 text-md-right"><button  type="submit" name="checkout" value="Checkout" class="borderradius50 fontsize14 btn btn-blue-fill">Proceed the checked</button></div>
