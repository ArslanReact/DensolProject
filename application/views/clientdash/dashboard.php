            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="admin-report gradientbg-warning align-items-center d-flex">
                        <div class="circle-gutter"><img class="img-fluid" src="<?=base_url();?>files/backend/images/tag-icon.svg" alt=""></div>
                        <div class="ml-4">
                            <h6><?php echo $dashboard_summay[0]['totaluncompleteorder']; ?></h6>
                            <div class="ddd">Total Pending Order</div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6">
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="admin-report gradientbg-pink align-items-center d-flex">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="ddd">Total Complete Order</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row m-t-20">
                <div class="col-xl-6 col-lg-6 m-b-20">
                    <div class="card">
                        ...
                        <div id="chartContainerorder" style="height: 370px; width: 100%;"></div>
                    </div>
                </div>                
                <div class="col-xl-6 col-lg-6 m-b-20">
                    <div class="card">
                        ...
                        <div id="chartContainersales" style="height: 370px; width: 100%;"></div>
                    </div>
                </div>                
            </div>
            <div class="card">
