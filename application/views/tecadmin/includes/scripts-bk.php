...
<script type="text/javascript" src="<?php echo base_url("files/backend/js-bk/");?>jquery.dataTables.js"></script>
<!--<script type="text/javascript" src="<?php //echo base_url("files/backend/js-bk/");?>dataTables.buttons.min.js"></script>-->

<!--<script type="text/javascript" src="<?php //echo base_url("files/backend/js-bk/");?>jszip.min.js"></script>-->
<!--<script type="text/javascript" src="<?php //echo base_url("files/backend/js-bk/");?>pdfmake.min.js"></script>-->
<!--<script type="text/javascript" src="<?php ///echo base_url("files/backend/js-bk/");?>vfs_fonts.js"></script>-->
<!--<script type="text/javascript" src="<?php //echo base_url("files/backend/js-bk/");?>buttons.html5.min.js"></script>-->
        ...
        $(document).ready(function(){
               ...
               $('.dataTables_length select').addClass('form-control mx-3');
                ...
                $('.pagination-list').addClass('d-flex');
                  $('.pagination-list li').addClass('page-item');
                  $('.pagination-list li a').addClass('page-link');
                  $('.dt-button').addClass('btn btn-all');
