                        ...
                        ?>
                            ...
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-left" style="font-size:20px;">Recover password</h3>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Recover</button>
                                    </div>
                                </div>
                                <p class="f-w-600 text-right"><a href="<?php echo base_url(ADMIN_FOLDER."/login")?>">Back to Login.</a></p>
