    ...
    <div class="col-xl-10 col-lg-9">
      ...
      <?php $this->load->view(ADMIN_VIEW_FOLDER."/includes/header");?>
            ...
            <div class="row m-b-20">
                <div class="col-xl-12">
                    <div class="card">
                <h2 class="display h4">Import Stock Excel Sheet <a href="<?php echo base_url() ?>uploads/stock_sample.csv" target="_blank" class="ml-2 btn btn-all float-right">Check Sample</a></h2>
                <?php
                $attributes = array('class' => 'form-material card-block', 'enctype' => "multipart/form-data");
                echo form_open_multipart(ADMIN_FOLDER.'/products/add_importindb',$attributes);
                ?>
                    <div class="form-row">
