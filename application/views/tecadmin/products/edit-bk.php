                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="short_detail" rows="3"><?php echo $product->short_detail;?></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="discounted_price" value="<?php echo $product->discounted_price;?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="row toclone m-t-20" style="position:relative;">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control editor" name="speciv[]" rows="3"><?php echo $sel_spec->content;?></textarea>
                                        </div>
                                    </div>
