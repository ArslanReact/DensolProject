          ...
          <div class="row d-flex align-items-md-stretch">
            ...
            <div class="col-lg-12 col-md-12 flex-lg-last flex-md-first align-self-baseline">
              <div class="card sales-report mt-10px">
                <h2 class="display h4">Edit Blog</h2>
                <p>Edit blog by Entring required detail.</p>
                <?php
                $attributes = array('class' => 'form-material card-block');
                echo form_open_multipart(ADMIN_FOLDER.'/blog/update',$attributes);
                ?>
                    <div class="form-row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" value="<?php echo $blog->slug;?>" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="short_detail" rows="3"><?php echo $blog->short_detail;?></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="author" class="form-control js-selectbox">
                                    <?php echo getUsersdrop($blog->author);?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control editor" name="content" rows="3"><?php echo $blog->content;?></textarea>
                            </div>
                        </div>
                        <div class="col-md-4 m-t-10">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <?php if($blog->icon != ""){?>
                                    <img src="<?php echo base_url()."uploads/blog/".$blog->icon;?>" style="max-height: 80px; margin-bottom: 15px;">
                        ...
                        <div class="col-md-4 m-t-10">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <img src="<?php echo base_url()."uploads/blog/".$blog->thumbnail;?>" style="max-height: 80px; margin-bottom: 15px;">
                                    <div class="checkbox-container">
                                        <label class="checkbox-label">
                        ...
                        <div class="col-md-4 m-t-10">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <?php if($blog->banner != ""){?>
                                    <img src="<?php echo base_url()."uploads/blog/".$blog->banner;?>" style="max-height: 80px; margin-bottom: 15px;">
                                    <div class="checkbox-container">
                                        <label class="checkbox-label">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="meta_title" value="<?php echo $blog->meta_title;?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Seo Description</label>
                                <textarea class="form-control" name="meta_desc" rows="3"><?php echo $blog->meta_desc;?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Seo Keyword</label>
                                <textarea class="form-control" name="meta_key" rows="3"><?php echo $blog->meta_key;?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <fieldset>
                                        ...
                                        <input type="radio" class="custom-control-input" name="is_active" value="1" id="customRadio3" <?php if($blog->is_active==1){?>checked="checked"<? }?>>
                                    ...
                                    <fieldset>
                                        <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="is_active" value="0" id="customRadio4" <?php if($blog->is_active==0){?>checked="checked"<? }?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Sort</label>
                                <input class="form-control" name="sort" value="<?php echo $blog->sort;?>" required="">
                            </div>
                        </div>
