          ...
          <div class="row d-flex align-items-md-stretch">
            ...
            <div class="col-lg-12 col-md-12 flex-lg-last flex-md-first align-self-baseline">
              <div class="card sales-report mt-10px">
                <h2 class="display h4">Create New Category</h2>
                <p>Add New Category by Entring required detail.</p>
                <?php
                $attributes = array('class' => 'form-material card-block');
                echo form_open_multipart(ADMIN_FOLDER.'/news/categories/add_submit',$attributes);
                ?>
                    <div class="form-row">
                        <div class="col-md-6">
