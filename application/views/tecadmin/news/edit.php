          ...
          <div class="row d-flex align-items-md-stretch">
            ...
            <div class="col-lg-12 col-md-12 flex-lg-last flex-md-first align-self-baseline">
              <div class="card sales-report mt-10px">
                <h2 class="display h4">Edit News</h2>
                <p>Edit News by Entring required detail.</p>
                <?php
                $attributes = array('class' => 'form-material card-block');
                echo form_open_multipart(ADMIN_FOLDER.'/news/update',$attributes);
                ?>
                    <div class="form-row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" value="<?php echo $news->slug;?>" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Icon Code (Optional)</label>
                                <input type="text" name="icon_code" value="<?php echo $news->icon_code;?>" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="short_detail" rows="3"><?php echo $news->short_detail;?></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>News Content</label>
                                <textarea class="form-control editor" name="content" rows="3"><?php echo $news->content;?></textarea>
                            </div>
                        </div>
                        <div class="col-md-4 m-t-10">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <?php if($news->icon != ""){?>
                                    <img src="<?php echo base_url()."uploads/news/".$news->icon;?>" style="max-height: 80px; margin-bottom: 15px;">
                        ...
                        <div class="col-md-4 m-t-10">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <img src="<?php echo base_url()."uploads/news/".$news->thumbnail;?>" style="max-height: 80px; margin-bottom: 15px;">
                                    <div class="checkbox-container">
                                        <label class="checkbox-label">
                        ...
                        <div class="col-md-4 m-t-10">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="Choose files To Upload">Choose files To Upload</label>
                                    <?php if($news->banner != ""){?>
                                    <img src="<?php echo base_url()."uploads/news/".$news->banner;?>" style="max-height: 80px; margin-bottom: 15px;">
                                    <div class="checkbox-container">
                                        <label class="checkbox-label">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="meta_title" value="<?php echo $news->meta_title;?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Seo Description</label>
                                <textarea class="form-control" name="meta_desc" rows="3"><?php echo $news->meta_desc;?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Seo Keyword</label>
                                <textarea class="form-control" name="meta_key" rows="3"><?php echo $news->meta_key;?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <fieldset>
                                        ...
                                        <input type="radio" class="custom-control-input" name="is_active" value="1" id="customRadio3" <?php if($news->is_active==1){?>checked="checked"<? }?>>
                                    ...
                                    <fieldset>
                                        <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="is_active" value="0" id="customRadio4" <?php if($news->is_active==0){?>checked="checked"<? }?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Sort</label>
                                <input class="form-control" name="sort" value="<?php echo $news->sort;?>" required="">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="btn-group mt-30px col">
                            <input type="hidden" name="page_id" value="<?php echo $news->id;?>">
