...
class BlogCategoriesModel extends CI_Model {
    ...
    public function getblogcategories($id=0)
    {
    ...
    public function get_all_blogcategories($id=0,$category=false)
    {
        if(!$category){
    ...
    public function update_blogcategory($id,$data,$slug=false,$update=true)
    {
        if($slug != false){
    ...
    public function add_blogcategory($slug,$data=array())
    {
        $slugarr = array('slug' => $this->create_slug($slug));
    ...
    public function update_sel_categories($id)
    {
        ...
        if ($query->num_rows() > 0){
            $data = array('blogcategory_id' => 0);
            $this->db->update($this->selcattable, $data, "blogcategory_id = ".$id);
            return true;
        }else{
            return false;
        }
