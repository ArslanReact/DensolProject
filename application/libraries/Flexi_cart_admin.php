...
// require_once("Flexi_cart_lite.php");
$CI =& get_instance();
...
class Flexi_cart_admin extends Flexi_cart_lite
{
	...
	public function get_db_order_query($sql_select = FALSE, $sql_where = FALSE)
	{
		if ($this->CI->flexi_cart_admin_model->get_enabled_status('orders'))
		{
			...
			$this->CI->db->select(array('ord_order_number','ord_demo_bill_name','ord_total_items','ord_total','ord_date','ord_status_description','payment_status'));
	...
	public function email_order($order_number = FALSE, $email_to = FALSE, $email_subject = FALSE, $custom_data = FALSE, $pdfFile = FALSE)
	{
		...
		if ($this->CI->flexi_cart_admin_model->email_order($order_number, $email_to, $email_subject, $custom_data, $pdfFile))
		{
