...
class Flexi_cart_lite
{
	...
	public function item_quantity($row_id = FALSE, $inc_discount = FALSE, $format = TRUE)
	{
		if (isset($this->CI->flexi->cart_contents['items'][$row_id]))
		{
			...
			if(isset($this->CI->flexi->cart_contents['settings']['configuration']['quantity_decimals'])){
				return $this->format_number($item_quantity, $format, $this->CI->flexi->cart_contents['settings']['configuration']['quantity_decimals']);
			}else{
				return $this->format_number($item_quantity, $format);
			}
		}
	 ...
	 */
	public function location_zones($zone_type = FALSE,$locationtype = FALSE)
	{
		return $this->CI->flexi_cart_lite_model->location_zones($zone_type,$locationtype);
	}
