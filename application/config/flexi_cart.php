...
*/
	...
	*/
	...
	$config['defaults']['shipping']['location'] = array('Australia');

	$config['defaults']['tax']['location'] = array('Australia');
	...
	$config['defaults']['currency']['name'] = 'AU';
	...
	$config['defaults']['configuration']['dynamic_reward_points'] = FALSE;
